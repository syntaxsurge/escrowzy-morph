        ...
        <div className='mx-auto max-w-7xl'>
          ...
          >
            ...
            <p className='mx-auto mb-12 max-w-2xl text-lg text-gray-400'>
              Built on cutting-edge Layer 2 technology for consumer-friendly
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm'>EIP-1559 Fee Mechanism</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>zkEVM Compatibility</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>Consumer Finance Focus</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>Fast Withdrawal Bridge</span>
                  </div>
                </div>
                <div className='rounded-lg bg-blue-950/40 p-3'>
                  <p className='text-xs text-blue-300'>
                    Optimized for consumer finance applications with low fees
                    and high throughput
                  </p>
                </div>
              </CardContent>
            ...
            <Card className='border-purple-500/30 bg-gradient-to-br from-purple-950/30 to-pink-950/30 backdrop-blur-sm'>
              ...
              <CardContent className='space-y-4'>
                <div className='space-y-2'>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>1 Second Block Time</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>0.001 Gwei Base Fee</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>48 Hour Withdrawal Period</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <CheckCircle2 className='h-4 w-4 text-green-400' />
                    <span className='text-sm'>600 Requests/Min Rate Limit</span>
                  </div>
                </div>
                <div className='rounded-lg bg-purple-950/40 p-3'>
                  <p className='text-xs text-purple-300'>
                    Enterprise-grade performance for consumer finance apps
                    applications
                  </p>
                </div>
              </CardContent>
